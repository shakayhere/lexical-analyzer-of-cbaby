...
public class Source {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.print("Enter path/filename for lexical analysis: ");
        ...
        FileWriter myWriter = new FileWriter("tokens(readable).txt");    // Creates tokens(readable).txt
        FileWriter myOriginalWriter = new FileWriter("tokens.txt");      // Creates tokens.txt
