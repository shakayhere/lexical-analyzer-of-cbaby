...
public class Source {
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        FileWriter myWriter = new FileWriter("write(readable).txt");    // Creates write(readable).txt
        FileWriter myOriginalWriter = new FileWriter("write.txt");      // Creates write.txt
